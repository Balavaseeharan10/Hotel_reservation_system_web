...
public class NRIResident {
    ...
    private String residentType = "NRI";
    ...
    public String getPurposeForVisit() { return purposeForVisit; }
    public void setPurposeForVisit(String purposeForVisit) { this.purposeForVisit = purposeForVisit; }
}
